...
import {GetStockRequestFromACompany as GetStockRequestFromACompanyAPI} from "../../../controller/InventoryController";
...
class StockRequest extends Component {
    ...
    getStockRequests = async () =>{
        ...
        let getStockRequestFromACompany = await GetStockRequestFromACompanyAPI(companyId);

        if(getStockRequestFromACompany.rdo === 200) {
            this.setState({
                stockRequests: getStockRequestFromACompany.data,
                active_view: 'main'
            });
        } else if(getStockRequestFromACompany.rdo === 400) {
            this.setState({
                active_view: 'error'
            });
        } else {
